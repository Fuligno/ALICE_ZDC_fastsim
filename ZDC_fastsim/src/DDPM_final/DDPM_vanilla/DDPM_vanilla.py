...
LAMBDA_SUM = 0.05
LAMBDA_PSUM_MSE      = 0.02   # MSE sulla somma (photon sum)
LAMBDA_CENTER_ARGMAX = 0.02   # MSE sul "centro" tipo argmax (soft-argmax differenziabile)
LAMBDA_GMAX          = 0.02   # MSE sul valore massimo (gamma_max)
LAMBDA_ENTROPY       = 0.02   # MSE sull'entropia normalizzata
CENTER_TAU           = 0.02   # temperatura soft-argmax (più bassa = più vicina all'argmax)
ENTROPY_EPS          = 0.05  # eps numerico per l'entropia
